...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ilsgateway_servicedeliverypointdgreport', (
            ...
            ('report_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 3, 9, 17, 44, 894000), auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 3, 9, 17, 44, 894000)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 3, 9, 17, 44, 893000)', 'auto_now_add': 'True', 'blank': 'True'}),
